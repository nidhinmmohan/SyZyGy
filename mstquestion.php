...
<form class="contactform">
  ...
  <!--       <li class="<?php if(basename($_SERVER['SCRIPT_NAME']) == 'gallery.php'){echo 'active'; }else { echo 'norm'; } ?>"><a href="gallery.php#focus">Vision</a></li>
    	...
    	<li class="<?php if(basename($_SERVER['SCRIPT_NAME']) == 'contact.php'){echo 'active'; }else { echo 'norm'; } ?>"><a href="contact.php#focus">Contact</a></li>-->
         <div class="clr"></div>
         <a href="index.php" style="text-decoration: none;color: #0099ff;">Home</a> 
         <a href="" style="text-decoration: none;color: #0099ff;">Company /</a> 
         <a href="" style="text-decoration: none;color:#0099ff;">Student Registration</a>
    </ul>
...
<h1 style="text-align:center;color:#114f9e;" id="focus">Mst Question</h1>
</div>

<article class="wrap" style="background-color:#fff;">
    <div class="ques" >
        
<div class="option_head" >1. sdhfb bhsdbvhs vh  s dv jfjhsd ?</div>
<div class="option1" >dfg</div>
<div class="option1" >gdfbcb</div>
<div class="option1" >dfgfbbf</div>
<div class="option1" >dfbdbdfb</div>
<div class="option1" >Answer coret</div>
    </div>
    <div class="clr"></div>
